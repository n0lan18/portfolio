	...
	return `
		...
		<div class="container-navigator-menu" id="container-navigator-menu">
			<ul class="navigator-list" id="navigator-list">
				...
				<li class="navigator-item">
					<a class="text-about-navigator text-menu-navigator" href="about.html" data-translate-key="about"></a>
				</li>
				<li class="navigator-item">
					<a class="text-send-message-navigator text-menu-navigator" href="send-message.html" data-translate-key="send-message"></a>
				</li>
