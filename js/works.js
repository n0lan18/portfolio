	...
	<div class="container-workspage" id="container-workspage">
		...
		<div class="container-projects-workspage">
			<div class="container-work-line-1">
				<div class="project-1">
					<div class="container-text-carrousel">
						<h2 class="name-carrousel" style="margin-bottom: 8px">Transcendance</h2>
				...
				<div class="project-2">
					<div class="container-text-carrousel">
						<h2 class="name-carrousel" style="margin-bottom: 8px">So_long</h2>
			...
			<div class="container-work-line-1">
				<div class="project-3">
					<div class="container-text-carrousel">
						<h2 class="name-carrousel" style="margin-bottom: 8px">Cub3D</h2>
